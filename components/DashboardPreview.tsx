...
import { IoCheckmarkDone, IoCheckmarkCircle, IoStatsChart, IoLibrary, IoCheckmark, IoCalendarOutline, IoDocument } from 'react-icons/io5';
...
export default function DashboardPreview() {
  ...
  return (
    <section id="dashboard" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50/30 to-transparent">
        ...
        >
          <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl shadow-2xl overflow-hidden border border-gray-800 hover:shadow-2xl transition-smooth">
            ...
            <div className="bg-gray-800 px-6 py-4 border-b border-gray-700 flex items-center justify-between animate-slide-down">
              <div>
                <h3 className="text-white font-semibold">StudentSphere Dashboard</h3>
              </div>
              <div className="flex gap-2">
                <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse-lg" />
                <div className="w-3 h-3 bg-yellow-500 rounded-full animate-pulse-lg" style={{ animationDelay: '0.2s' }} />
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse-lg" style={{ animationDelay: '0.4s' }} />
              </div>
            </div>
            ...
            <div className="p-6 grid md:grid-cols-4 gap-6">
              ...
              <div className="md:col-span-1 space-y-3 animate-slide-in-left">
                <div className="bg-gray-800 rounded-lg p-3 border border-blue-600 border-opacity-50 hover:border-blue-400 transition-smooth flex items-center gap-2">
                  ...
                  <p className="text-xs font-semibold text-blue-400">Dashboard</p>
                </div>
              ...
              <div className="md:col-span-3 space-y-6 animate-slide-in-right">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-900 to-purple-800 rounded-lg p-4 border border-purple-700 hover:shadow-lg transition-smooth hover:scale-105 animate-scale-in" style={{ animationDelay: '0.1s' }}>
                    <p className="text-xs text-purple-300 mb-2">Upcoming Exams</p>
                    <p className="text-2xl font-bold text-white">5</p>
                  </div>
                  <div className="bg-gradient-to-br from-green-900 to-green-800 rounded-lg p-4 border border-green-700 hover:shadow-lg transition-smooth hover:scale-105 animate-scale-in" style={{ animationDelay: '0.2s' }}>
                  ...
                  <div className="space-y-3">
                    <div className="hover:bg-gray-800/50 p-2 rounded transition-smooth">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs text-gray-300">Mathematics</span>
          ...
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse-lg" />
          <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse-lg" style={{ animationDelay: '0.5s' }} />
        </div>
      </div>
    </section>
  );
